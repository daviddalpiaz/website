...
**Effective November 26, 2020, I will no longer be accepting letter request for the next admission cycle. (So, let's say anything with a deadline before the end of the Spring 2021 semester.) Given the classes and number of students I teach, my letter writing output is already very high, but this cycle I have accepted a record number of letter requests that far exceeds my norm. I worry that if I continue to accept requests, I will be unable to fulfill my existing writing commitments in a timely manner.** 
